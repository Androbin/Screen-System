...
public final class GameScreenManager implements Renderable
{
	...
	private void crossfade( final Transition.Type type, final Screen screen, final Transition crossfade, final float duration )
	{
	...
	public void crossfadeCall( final Screen screen, final Transition crossfade, final float duration )
	{
		if ( screen != null )
		{
	...
	public void crossfadeSwitch( final Screen screen, final Transition crossfade, final float duration )
	{
		if ( screen == null )
		{
	...
	public void render( final Graphics2D g )
	{
		if ( ts.crossfading )
		{
			...
			final BufferedImage image1 = new BufferedImage( game.getWidth(), game.getHeight(), BufferedImage.TYPE_INT_RGB );
			final BufferedImage image2 = new BufferedImage( game.getWidth(), game.getHeight(), BufferedImage.TYPE_INT_RGB );
